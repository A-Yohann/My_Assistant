 ...
 */
final class Version20260324123417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_budgetaire ADD CONSTRAINT FK_7C936380A4AEAFEA FOREIGN KEY (entreprise_id) REFERENCES entreprise (id)');
        ...
        $this->addSql('ALTER TABLE user ADD plan VARCHAR(20) DEFAULT \'free\' NOT NULL, ADD plan_expires_at VARCHAR(255) DEFAULT NULL, ADD stripe_customer_id VARCHAR(255) DEFAULT NULL, ADD stripe_subscription_id VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_budgetaire DROP FOREIGN KEY FK_7C936380A4AEAFEA');
        ...
        $this->addSql('ALTER TABLE user DROP plan, DROP plan_expires_at, DROP stripe_customer_id, DROP stripe_subscription_id');
    }
}
