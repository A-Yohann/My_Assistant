 ...
 */
final class Version20260317085854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_budgetaire ADD categorie VARCHAR(50) NOT NULL, ADD user_id INT DEFAULT NULL, CHANGE justificatif justificatif LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE depense_budgetaire ADD CONSTRAINT FK_7C936380A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_7C936380A76ED395 ON depense_budgetaire (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7C936380A76ED395 ON depense_budgetaire');
        $this->addSql('ALTER TABLE depense_budgetaire DROP categorie, DROP user_id, CHANGE justificatif justificatif LONGTEXT NOT NULL');
