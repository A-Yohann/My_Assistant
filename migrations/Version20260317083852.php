 ...
 */
final class Version20260317083852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bon_de_commande (id INT AUTO_INCREMENT NOT NULL, numero_bon VARCHAR(50) NOT NULL, date_creation DATE NOT NULL, montant_ht NUMERIC(10, 2) NOT NULL, montant_ttc NUMERIC(10, 2) NOT NULL, taux_tva NUMERIC(5, 2) NOT NULL, description LONGTEXT NOT NULL, etat VARCHAR(20) NOT NULL, entreprise_id INT DEFAULT NULL, devis_id INT DEFAULT NULL, INDEX IDX_2C3802E4A4AEAFEA (entreprise_id), UNIQUE INDEX UNIQ_2C3802E441DEFADA (devis_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
