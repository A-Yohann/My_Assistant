 ...
 */
final class Version20260312092259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dashbord MODIFY id_dashbord INT NOT NULL');
        $this->addSql('ALTER TABLE dashbord CHANGE id_dashbord id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dashbord MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE dashbord CHANGE id id_dashbord INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_dashbord)');
