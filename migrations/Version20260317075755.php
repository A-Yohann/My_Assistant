 ...
 */
final class Version20260317075755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD signature_token VARCHAR(64) DEFAULT NULL, ADD signature_date DATETIME DEFAULT NULL, ADD signature_image LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis DROP signature_token, DROP signature_date, DROP signature_image');
