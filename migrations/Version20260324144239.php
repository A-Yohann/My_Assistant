 ...
 */
final class Version20260324144239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE plan_expires_at plan_expires_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE plan_expires_at plan_expires_at VARCHAR(255) DEFAULT NULL');
    }
}
