 ...
 */
final class Version20260312092417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise CHANGE telephone telephone VARCHAR(10) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise CHANGE telephone telephone VARCHAR(10) NOT NULL');
