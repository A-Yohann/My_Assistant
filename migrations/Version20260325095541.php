 ...
 */
final class Version20260325095541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD login_attempts INT DEFAULT 0 NOT NULL, ADD locked_until DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP login_attempts, DROP locked_until');
    }
}
