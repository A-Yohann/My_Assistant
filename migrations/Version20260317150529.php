 ...
 */
final class Version20260317150529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depense_budgetaire ADD entreprise_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_7C936380A4AEAFEA ON depense_budgetaire (entreprise_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7C936380A4AEAFEA ON depense_budgetaire');
        $this->addSql('ALTER TABLE depense_budgetaire DROP entreprise_id');
