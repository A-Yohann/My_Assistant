 ...
 */
final class Version20260317084013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, numero_facture VARCHAR(50) NOT NULL, date_creation DATE NOT NULL, date_echeance DATE DEFAULT NULL, montant_ht NUMERIC(10, 2) NOT NULL, montant_ttc NUMERIC(10, 2) NOT NULL, taux_tva NUMERIC(5, 2) NOT NULL, description LONGTEXT NOT NULL, etat VARCHAR(20) NOT NULL, entreprise_id INT DEFAULT NULL, bon_de_commande_id INT DEFAULT NULL, INDEX IDX_FE866410A4AEAFEA (entreprise_id), UNIQUE INDEX UNIQ_FE866410D29E677C (bon_de_commande_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
