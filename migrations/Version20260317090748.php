 ...
 */
final class Version20260317090748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD numero_rue VARCHAR(10) DEFAULT NULL, ADD nom_rue VARCHAR(100) DEFAULT NULL, ADD code_postal VARCHAR(10) DEFAULT NULL, ADD ville VARCHAR(100) DEFAULT NULL, ADD pays VARCHAR(100) DEFAULT NULL, ADD user_id INT DEFAULT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE telephone telephone VARCHAR(20) NOT NULL');
        ...
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT FK_8B27C52B19EB6921 FOREIGN KEY (client_id) REFERENCES client (idClient)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client DROP numero_rue, DROP nom_rue, DROP code_postal, DROP ville, DROP pays, DROP user_id, CHANGE email email VARCHAR(50) NOT NULL, CHANGE telephone telephone VARCHAR(10) NOT NULL');
